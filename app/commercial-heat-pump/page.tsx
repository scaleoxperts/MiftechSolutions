...
const features = [
  ...
  "Suitable for hotels, hostels, hospitals, commercial spaces, and industries",
    ...
    <>
      <section className="pt-32 pb-16 bg-[var(--white)]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-6xl font-bold font-playfair text-[var(--text-dark-gray)] max-w-4xl">Commercial Heat Pump</h1>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl">Powerful, high-performance solutions designed for the demands of commercial and industrial applications.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="relative w-full h-96 lg:h-[500px] rounded-lg overflow-hidden shadow-xl">
                    <Image src="/images/demo-branding-agency-services-detail-02.jpg" alt="Commercial Heat Pump" layout="fill" objectFit="cover" />
                </div>
                <div>
